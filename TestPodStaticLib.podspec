...
A testing static lib pod used to check how static lib can be used.
  ...
  s.homepage         = 'https://github.com/FazalElahi/TestPodStaticLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'FazalElahi' => 'fazal.elahi@consoliads.com' }
  s.source           = { :git => 'https://github.com/FazalElahi/TestPodStaticLib.git', :tag => s.version.to_s }
  ...
  s.ios.vendored_library = 'TestPodStaticLib/libTestStatic.a'
#  s.libraries      = 'AdobeMobileLibrary'
  s.xcconfig = {
